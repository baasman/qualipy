...
project = qpy.Project(
    project_name="flat_data_with_complex_function", config_dir="~/flat_data"
)
...
subprocess.check_output(
    "qualipy produce-anomaly-report ~/flat_data flat_data_with_complex_function --run_anomaly true --out_file ~/flat_with_complex_function.html",
    shell=True,
)